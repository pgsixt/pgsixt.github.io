...
### 게시 일정
- 본 온라인 기도실은 올해 12월까지 업데이트 됩니다. 현재 **구약 인물들의 기도**를  게시 중이며, 이후 절기등에 맞춰 게시될 예정입니다. 이후 정비후 다시 게시될 예정입니다.
...
위의 주소로 가시면, 가장 최신화된 온라인기도실을 사용하실 수 있습니다. 각 교회별 이름을 넣거나, 성도들의 기도제목을 받을 수 있도록 도와드립니다. 온라인기도실의 내용은 별도의 공고없이 지속적으로 수정됩니다.
...
### 4. 내용 확인하기
현재 9주차에만 적용이 되는 기능입니다. 주소 뒤에 &all=1를 붙이시면 전체 내용을 한 눈에 보실 수 있습니다.
