...
#### 3.1 페이지 수정시 안내사항
- 온라인 기도실 내부는 html 태그를 직접 넣으셔서 작성하실 수도 있고, 단축어를 이용하실 수도 있습니다.
- 기도실은 보통 17장의 슬라이드로 구성되어 있고, 각 슬라이드는 상단에 배경을 설정합니다. 

    div class='maincard clearfix'  data-bg='모바일그림주소' data-desktop='PC화면그림주소'
- 각 내용은 태그이름::들어갈 내용으로 구성됩니다.
- 꺽쇠 표시는 노란색으로 강조할 때 사용되며, 이중 꺽쇠는 한단계 작은 글씨입니다.
- 굵은 줄을 === (3개만), 가는 줄은  --- (3개만)
- 설명은 기도에 대한 전반적인 안내문구입니다. 
- 줄바꿈:: 은 줄을 바꿀때 사용합니다 (엔터키와 같으며 < br/> 태그와 같습니다.

- 정렬
- 정렬은 기본적으로는 왼쪽 정렬이며, 가운데, 오른쪽을 추가하면 정렬 위치를 바꿀수 있습니다.

- 크기
- 크기는 큰본문, 중간본문, 작은본문 3단계로 이루어 집니다. 태그로는 h4, h5, h6 입니다.
- 일반적인 설명은 중간본문을 기준으로 하시면 보기에 적절합니다.
- 부수적인 내용은 작은 본문으로 하시면 좋습니다.

- 예
- 오른쪽작은본문:: 정렬은 오른쪽으로, 글씨크기는 작은 것으로
- 가운데중간본문:: 정렬은 가운데로, 글씨크기는 중간으로
- 큰본문:: 정렬은 왼쪽(기본)으로, 글씨크기는 크게

- 다음버튼:: (필수요소)
- 다음페이지로 넘어가기 위한 필수 요소입니다. 다음버튼:: 다음에 나오는 문구는 버튼안에 들어갈 문구입니다.

아래는 예시입니다.

제목::여기 제목이 들어갑니다.<br/>
===<br/>
설명*::이곳은 주님께 나아가는 자리입니다.<br/>
설명*::30분 정도 여유를 갖고 하시길 바랍니다.<br/>
설명*::말씀과 묵상, 찬양과 기도로 함께 합니다.<br/>
설명*::하단의 버튼을 누르면 다음 기도제목으로 넘어갑니다.<br/>
---<br/>
줄바꿈::<br/>
중간본문::[성령님]께서 우리의 기도를 인도해 주십니다. 도우심을 구하며 기도를 시작합니다.<br/>
줄바꿈::<br/>
오른쪽작은본문::준비가 되면, 아래의 [버튼]을 눌러주세요. <br/>
줄바꿈::<br/>
